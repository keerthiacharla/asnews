...
?>
			<div class="section_conatiner">
				...
				<?php
					...
					$sql1 = "SELECT * FROM users WHERE user_id = {$aut_cid}";
					$result1= mysqli_query($conn,$sql1) or die("Pagination Query Faied");
					$row1 = mysqli_fetch_assoc($result1);
				?>
				
					<h1 class="heading"><?php echo $row1["first_name"]."  " .$row1["last_name"]; ?> </h1>
				<hr>
					<?php
							include "config.php";
					...
					<div class="section_group">
						...
						<div class="field_container">
							...
							<div class="field_par">
								...
								<span> <h5><i class="fa fa-user"><a href="author.php"><?php echo $row['first_name']." " .$row['last_name'];?></a></i></h5></span>
				...
				<?php
					...
					if(mysqli_num_rows($result1)){
						...
						$total_records = $row1['username'];
						
						$total_page = ceil($total_records / $limit);
						
						echo '<ul class="pagination">';
						if($page > 1){
							echo '<li><a href="author.php?aid='.$aut_cid.'&page=',($page - 1),'"> PREV</a></li>';
						}
						...
						echo '<li class ="'.$active.'"><a href="author.php?aid='.$aut_cid.'&page='.$i.'">'.$i.'</a></li>';	
						}
						if($total_page > $page){
							echo '<li><a href="author.php?aid='.$aut_cid.'&page=',($page + 1),'"> NEXT</a></li>';
						}
						echo '</ul>';
					}
					?>
